      ...
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        >
          <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
            {navigation.map((item) => {
              const isActive = item.url === pathname.hash;
                ...
                <a
                  ...
                  className={`
                    ...
                    ${
                      isActive
                        ? "text-n-1"
                        : "text-n-1 opacity-50 hover:opacity-100"
                    }
                    hover:text-n-1
        ...
        <a
          href="#signup"
          className="button hidden mr-8 text-n-1 opacity-50 hover:opacity-100 transition-colors lg:block"
        >
          New account
        </a>
