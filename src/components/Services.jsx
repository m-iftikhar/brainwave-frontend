    ...
    <Section id="how-to-use">
      <div className="container ">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-156 mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-184 lg:ml-15">
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2 lg:ml-15">
